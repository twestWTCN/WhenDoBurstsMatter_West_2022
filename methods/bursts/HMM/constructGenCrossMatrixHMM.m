...
%                                 [E,nbs(:,i,C)] = burstAmpHist(dataX(:,i)',fsamp,R.data.feat_xscale{fcnt},minbs,winmark,dataC);
                                [E,nbs(:,i,C),~,~,burstInds] = burstAmpHistHMM(dataX(:,i)',fsamp,R.data.feat_xscale{fcnt},minbs,winmark,dataC);
                            case 'DURPDF'
                                [E,nbs(:,i,C)] = burstDurHistHMM(dataX(:,i)',fsamp,R.data.feat_xscale{fcnt},minbs,winmark,burstInds);
                            case 'INTPDF'
                                [E,nbs(:,i,C)] = burstIntHistHMM(dataX(:,i)',fsamp,R.data.feat_xscale{fcnt},minbs,winmark,burstInds);
